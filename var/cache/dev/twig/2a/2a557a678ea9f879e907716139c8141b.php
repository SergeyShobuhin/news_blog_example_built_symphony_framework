...
class __TwigTemplate_35ae5a39a8f55e45c9b979c4149dfb9a extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("layout.html.twig", "login/index.html.twig", 2);
    ...
    <form action=\"";
        ...
        ";
        // line 25
        yield "        <button type=\"submit\">заходь</button>

        <br>
        <div class=\"\">
            <p style=\"padding-top: 20px; color: indianred \">Если нет аккаунта.</p>
            <a class=\"btn btn-lg btn-primary\" href=\"";
        // line 30
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("app_register");
        yield "\">Зарегистрируйся</a></p>
        </div>
...
";
    ...
    {
        return array (  130 => 30,  123 => 25,  118 => 21,  110 => 16,  105 => 14,  102 => 13,  96 => 11,  94 => 10,  90 => 8,  80 => 7,  60 => 5,  37 => 2,);
    }
...
{% block body %}
    ...
    <form action=\"{{ path('app_login') }}\" method=\"post\">
        ...
        <button type=\"submit\">заходь</button>

        <br>
        <div class=\"\">
            <p style=\"padding-top: 20px; color: indianred \">Если нет аккаунта.</p>
            <a class=\"btn btn-lg btn-primary\" href=\"{{ url('app_register') }}\">Зарегистрируйся</a></p>
        </div>

    </form>
{% endblock %}
", "login/index.html.twig", "/var/www/symfonytask/task_project/templates/login/index.html.twig");
    }
}
